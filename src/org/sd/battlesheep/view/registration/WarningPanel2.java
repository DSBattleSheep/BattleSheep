...
public class WarningPanel2 extends AShipPanel
{
	...
	public WarningPanel2() {
		...
		hackingLabel = new JLabel("The game is going to be hacked...", WAIT, JLabel.CENTER);
		...
		add(hackingLabel, BorderLayout.CENTER);
	}
